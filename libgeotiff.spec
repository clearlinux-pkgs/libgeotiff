...
Source0  : https://github.com/OSGeo/libgeotiff/releases/download/1.7.3/libgeotiff-1.7.3.tar.gz
Summary  : GeoTIFF file format library
...
%prep
%setup -q -n libgeotiff-1.7.3
cd %{_builddir}/libgeotiff-1.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720050311
